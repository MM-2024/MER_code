...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(my_config.PATH_TO_FEATURES[params.dataset], save_name)
    if not os.path.exists(save_dir): os.makedirs(save_dir)

    # load pre-trained model
    pretrained_dir = os.path.join(my_config.PATH_TO_PRETRAINED_MODELS, 'ferplus') # directory of pre-trained models
