...
#python -u extract_imagenet_embedding.py  --dataset=MER2024 --feature_level='UTTERANCE'         --gpu=0    
...
if __name__ == '__main__':
    ...
    save_dir = os.path.join(my_config.PATH_TO_FEATURES[params.dataset], f'imagenet_{params.feature_level[:3]}')
