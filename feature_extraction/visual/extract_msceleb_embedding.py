...
if __name__ == '__main__':
    ...
    save_dir = os.path.join(my_config.PATH_TO_FEATURES[params.dataset], f'msceleb_{params.feature_level[:3]}')
    if not os.path.exists(save_dir): os.makedirs(save_dir)

    # load model
    checkpoint_file = os.path.join(my_config.PATH_TO_PRETRAINED_MODELS, 'msceleb/resnet18_msceleb.pth')
