...
class MER2023_UNLABEL:
    ...
    def __init__(self, args):
        ...
        self.face_root = my_config.PATH_TO_RAW_FACE[args.dataset]
        self.video_root = my_config.PATH_TO_RAW_VIDEO[args.dataset]
        self.name2len_path = os.path.join(my_config.DATA_DIR[args.dataset], 'unlabel-name2len.npz')
