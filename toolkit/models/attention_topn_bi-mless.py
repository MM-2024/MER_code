...
from .cross_model.BiDirectional_Attention import BiDirectionalAttention
...
class Attention_TOPN(nn.Module):
    def __init__(self, args):
        ...
        "新加 双向注意力"
        self.BiDirectionalAttention_layer = BiDirectionalAttention(hidden_dim)
    ...
    def forward(self, batch):
        ...
        "新加"
        ## Compute audio Aware Learning video feature
        QAL_feature = self.BiDirectionalAttention_layer(video_feature, audio_feature,
